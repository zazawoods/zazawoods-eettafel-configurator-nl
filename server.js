...
const SHOP_ORIGIN = process.env.SHOP_ORIGIN || 'https://zazawoods.nl';
...
const REF_PRODUCT_HANDLES = (process.env.REF_PRODUCT_HANDLES ||
  'massief-eiken-tafel-deens-ovaal-salvatore-met-verjongde-rand,organische-eettafel-pure-van-massief-eikenhout,halfronde-eettafel-van-massief-eikenhout'
