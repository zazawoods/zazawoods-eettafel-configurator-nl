...
import { TABLE_SHAPES, MATERIAL_TYPES, EDGE_OPTIONS, POWDER_COAT_COLORS, DEFAULT_STATE, BUILD_VERSION } from './config.js?v=d8a2f5e7';
// NL locale layer: canonical (German) titles internally, Dutch labels via L()/T().
import { L, T, SHOP_URL, LOCALE, canonicalizeProducts, canonicalTitle } from './locale.js?v=d8a2f5e7';
...
import { fetchAllPrices, formatPrice, getCachedTotal, setCachedTotal } from './shopify.js?v=d8a2f5e7';
...
class TableConfigurator {
  ...
  _showGpuFailOverlay() {
    ...
    ov.innerHTML =
      '<div style="font-size:15px;color:#555;max-width:300px;">De 3D-weergave is door uw apparaat gestopt (te weinig grafisch geheugen). Sluit andere tabbladen en laad de pagina opnieuw.</div>' +
      '<button id="zw-gpu-fail-btn" style="background:#577476;color:#fff;border:0;border-radius:8px;padding:12px 32px;font-size:15px;cursor:pointer;">Pagina opnieuw laden</button>';
