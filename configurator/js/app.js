...
import { TABLE_SHAPES, MATERIAL_TYPES, EDGE_OPTIONS, POWDER_COAT_COLORS, DEFAULT_STATE, BUILD_VERSION } from './config.js?v=e5d7a3b9';
// NL locale layer: canonical (German) titles internally, Dutch labels via L()/T().
import { L, T, SHOP_URL, LOCALE, canonicalizeProducts, canonicalTitle } from './locale.js?v=e5d7a3b9';
...
import { fetchAllPrices, formatPrice, getCachedTotal, setCachedTotal } from './shopify.js?v=e5d7a3b9';
